...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Helper Function
	var searches = __webpack_require__(182);
	...
	var Main = React.createClass({
		...
		saveArticle: function saveArticle(title, date, url) {
			searches.postArticle(title, date, url);
			this.getArticle();
		},
		...
		componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
			...
			if (prevState.topic != this.state.topic) {
				...
				searches.runQuery(this.state.topic, this.state.startYear, this.state.endYear).then(function (data) {
					console.log(data);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							{ className: 'text-center', style: { 'color': 'black', 'textShadow': '2px 2px 10px black', 'fontSize': '50px' } },
							'New York Times Articles Scrubber'
						),
						React.createElement(
							'p',
							{ className: 'text-center', style: { 'color': 'black', 'textShadow': '2px 2px 10px black', 'fontSize': '20px' } },
		...
		componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
			...
			var myResults = nextProps.results.map(function (search, i) {
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ type: "button", className: "btn btn-info", style: { 'float': 'right', 'marginTop': '-39px' }, onClick: boundClick },
						"Save"
					)
				);
			});
				...
				return React.createElement(
					...
					React.createElement(
						...
						{ type: "button", className: "btn btn-danger",
							style: { 'float': 'right', 'marginTop': '-39px' }, onClick: boundClick },
						"Delete"
					)
				);
			});
